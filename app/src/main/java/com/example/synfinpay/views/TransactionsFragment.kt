...
import com.example.synfinpay.databinding.FragmentTransactionnsBinding
import com.example.synfinpay.utils.setToolbarTitleTransparent


class TransactionsFragment : Fragment() {
private lateinit var transactionsAdapter:TransactionAdapter
private lateinit var binding :FragmentTransactionnsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTransactionnsBinding.inflate(layoutInflater)
        return  binding.root
    }
    ...
    private fun initRecyclerView(){
        transactionsAdapter= TransactionAdapter(object:OnTransactionAdapterItemClicked{
            override fun onTransactionItemClicked(transactionItems: TransactionItems) {
                findNavController().navigate(R.id.runningOrderFragment)
            }
